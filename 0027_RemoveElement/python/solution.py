...
def initial_pass(nums: list[int], val: int) -> int:
    # Set up two pointers
    # 1 tracks the index position of the end of the portion of the list that does not
    # contain the value
    # The other points to a position at the end to swap the unwanted value to
    # When the pointers meet we have checked all the values
    left_index = 0
